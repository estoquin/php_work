...
<body class="bg-dark">
    <h1 class="display-6 title text-center my-4">Others projects</h1>
    ...
    <div class="links">
        <div class="row justify-content-center">
                <div class="app mx-5 my-1 p-3 rounded text-center shadow">
                 ...
                 <div class="app mx-5 my-1 p-3 rounded text-center shadow">
                     <a href="https://vision456.herokuapp.com/" target="_blank" ><img class="pt-5 pb-4" src="vision-logo.png" srcset=""></a>
                     <p class="p-2">VISION</p>
                     <p>(NodeJS)</p>
                 </div>     
        </div>
    </div>
    ...
    <div class="p-5 m-3 rounded shadow explanation">
        <ul>
            ...
            <li><p>Vision was just an attempt to use only bootstrap to style it and i used the template to try a simple node server.</p></li>
