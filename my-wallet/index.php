<?php include('app/db_connect.php'); 
// https://mywallet-n1.000webhostapp.com/view/out/register.php
// There is where the app is gonna be upload
?>
...
<body>
    ...
    <div class="container">
        <div class="box" id="login">
            ...
            <a href="view/out/register.php" class="btn btn-primary btnn">Register</a>
        </div>
    </div>
